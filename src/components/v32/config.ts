...
export const COLORS = {
  ...
  // Voxel CRUISE SHIP (v31) — Option A "Cool pearl". A cool pale grey-white hull
  // + superstructure that reads against the WARM pale dawn (a pure white would
  // vanish), a dark slate waterline for legibility, a mid-grey window band, and a
  // small warm CORAL funnel accent for life. Distant → softened via shipOpacity.
  // (Options B "Warm ivory" / C "Slate & white" are in the reply to switch to.)
  shipHull: '#D7DFE4', // cool pale grey-white — main hull + superstructure
  shipHullHi: '#E7ECEF', // upper deck (a touch lighter)
  shipWaterline: '#5C6770', // dark slate hull base / waterline stripe (legibility)
  shipDeckLine: '#9CA9B0', // mid-grey window / detail band
  shipFunnel: '#FF6B4A', // warm coral funnel (brand accent — life)
  shipFunnelDark: '#D8543A', // funnel cap rim (darker coral)
};
...
export const DEFAULT_CONFIG: PalmConfig = {
  ...
  shipOpacity: 0.93, // cruise ship — now clearly solid/distinct (was 0.66)
