...
// Smaller, modest ship: shrink length + beam more than height so it still reads
// as a multi-deck liner while taking up less space (was a single SCALE = 1.0).
const SX = 0.68; // length
const SY = 0.82; // height (kept taller so the stacked decks still read)
const SZ = 0.68; // beam
