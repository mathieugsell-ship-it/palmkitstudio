...
import { HorizonPitons } from './HorizonPitons';
  ...
  return (
    <div ref={wrapRef} className="h-full w-full" style={{ background: dawnBg }}>
      ...
      >
        ...
        {/* Distant karst pitons on the horizon — hazy, static backdrop. OUTSIDE
            the rotation group so they stay a fixed far horizon. */}
        <HorizonPitons config={config} />
