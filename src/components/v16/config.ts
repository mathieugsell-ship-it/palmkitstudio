...
export const COLORS = {
  ...
  // Distant HORIZON karst pitons (v16) — Option A "pale cool haze". Desaturated
  // light grey blending toward the dawn, low opacity = atmospheric distance.
  // Tiny muted green crown. (Options B/C hexes are in the reply.)
  horizonRock: '#C4CAD0', // pale cool limestone grey (hazy)
  horizonCrown: '#9BB7A6', // muted, greyed green vegetation hint
  horizonEdge: '#AEB6BE', // very faint edge tint
  horizonRockOpacity: 0.45, // haze — dawn shows through
  horizonCrownOpacity: 0.4,
  horizonEdgeOpacity: 0.16,
};
