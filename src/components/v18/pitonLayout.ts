...
// ---- placement (tunable) — pushed DEEPER into the scene (further back, behind
// the islet, slight right) vs v17, for depth. They now sit BEYOND the water ring
// (distant rocks behind the sea), no longer rooted in it — intentional. ONLY
// cx/cz changed; size/shape/colours/solidity identical to v15/v17.
const MAIN: PitonSpec = {
  cx: 3.0, cz: -4.2, levels: 7, segH: 0.42, baseW: 0.5, topW: 1.12,
  rootDepth: 0.32, driftX: -0.2, driftZ: 0.1, seed: 11,
};
const SMALL: PitonSpec = {
  cx: 3.8, cz: -3.2, levels: 4, segH: 0.4, baseW: 0.34, topW: 0.72,
