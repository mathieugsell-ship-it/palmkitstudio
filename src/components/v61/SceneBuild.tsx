...
import { FocusDressing } from './FocusDressing';
...
export function SceneBuild({ config, bloom, pulse, animate, reducedMotion, gate = 'build', noHover = false, labels, onHit, onBuildComplete, focusActive = false, compact = false }: Props) {
  ...
  return (
    <group>
      ...
      {/* v61: premium FOCUS dressing (pedestal + warm halo + golden dust). Only
          visible while focused; fades + follows the focused object to its slot.
          Generic — reused for any focused object later (pass that object's
          pivot/base/size). For this step it dresses the PALM focus. */}
      <FocusDressing
