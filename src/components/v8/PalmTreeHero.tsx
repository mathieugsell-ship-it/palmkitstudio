  ...
  return (
    <div ref={wrapRef} className="h-full w-full" style={{ background: dawnBg }}>
      ...
      >
        ...
        {/* Whole scene rotates together — but only AFTER the palm has built
            (held still during the assembly, then eased in). */}
        <IdleRotation enabled={built && rotate} easeIn={config.build.rotateEaseIn}>
          ...
          {/* Ripple animates throughout (incl. during the palm build). */}
