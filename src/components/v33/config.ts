...
export const COLORS = {
  ...
  // Voxel CRUISE SHIP (v33) — Option A "Warm cream + navy". A warm CREAM hull +
  // superstructure that pops against the cool turquoise water (the old cool-grey
  // blended in), a strong DARK-NAVY base band at the waterline (classic liner
  // hull, instant read), a darker window band for deck detail, and a small warm
  // CORAL funnel accent. (Options B "Clean white + red" / C "Ivory + teal-navy"
  // are in the reply to switch to.)
  shipHull: '#F1E7D0', // warm cream — main hull + lower superstructure
  shipHullHi: '#F8F1E2', // upper decks (lighter cream)
  shipWaterline: '#2C3E50', // dark navy base band at the waterline (strong contrast)
  shipDeckLine: '#6E7A86', // slate window / deck-detail band
...
export const DEFAULT_CONFIG: PalmConfig = {
  ...
  shipOpacity: 0.99, // cruise ship — essentially solid so it doesn't get lost in the water
