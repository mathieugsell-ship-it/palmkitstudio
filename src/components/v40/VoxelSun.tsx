...
// Placement (tunable): low on the horizon, in the GAP between the two left karst
// pitons (which sit closer, at d~7.8) so it rises through the gap, framed by the
// rocks. Far behind them (d~16) and a touch right of its old spot.
const SUN_POS: [number, number, number] = [-11, 1.0, -12];
