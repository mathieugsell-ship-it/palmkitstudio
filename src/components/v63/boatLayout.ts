...
// ---- placement (tunable) — v42: nudged a bit more to the LEFT onto open
// foreground water so it's clearly off the (receded) palm island — screen sx ~36
// vs the palm at ~49. Whole hull + shaft still afloat, clear of the offset
// island (verified). Prow angled toward the viewer.
const CX = -0.3;
const CY = -0.42; // waterline reference
const CZ = 2.3; // foreground open water, off to the left of the palm
