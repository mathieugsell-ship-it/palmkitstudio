...
export interface PalmConfig {
  ...
  faceOpacity: number;
  /** Island base translucency — MORE transparent than the palm so it recedes. */
  baseOpacity: number;
  /** Small subtle teal nodes on the base too (vs none). */
  baseNodes: boolean;
}
...
export const COLORS = {
  ...
  // Island base — cool, desaturated sand (Option A "Cool driftwood"), derived
  // to harmonize with the muted greens (NOT warm cream/gold). Editable here.
  sandDry: '#C5BE9E', // dry sand the palm plants into
  sandDamp: '#A79D79', // damp shoreline rim (water meets this next step)
  sandUnder: '#B3AA86', // floating underside, upper chunk
  sandUnderDeep: '#998F73', // floating underside, lower tip
};
