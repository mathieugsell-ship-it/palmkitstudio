...
export const HOTSPOTS: HotspotConfig[] = [
  ...
  { id: 'local-seo', label: 'Local SEO', blurb: 'Found by nearby customers', anchor: { type: 'frondTip', frond: 2 } },
  { id: 'growth', label: 'Growth', blurb: 'More reach, more leads', anchor: { type: 'frondTip', frond: 4 } },
  { id: 'ai-automation', label: 'AI Automation', blurb: 'Smart, time-saving workflows', anchor: { type: 'crown' } },
  { id: 'ecommerce', label: 'E-commerce', blurb: 'Stores that sell', anchor: { type: 'frondTip', frond: 6 } },
  { id: 'brand', label: 'Brand', blurb: 'Identity & design', anchor: { type: 'trunk', t: 0.55 } },
];
