...
// ---- placement (tunable) — moved further BACK-RIGHT vs v15 (behind/beside the
// islet, well clear of the palm) while staying rooted in the water ring. ONLY
// cx/cz changed from v15; size/shape/colours/solidity are identical.
const MAIN: PitonSpec = {
  cx: 2.9, cz: -1.9, levels: 7, segH: 0.42, baseW: 0.5, topW: 1.12,
  rootDepth: 0.32, driftX: -0.2, driftZ: 0.1, seed: 11,
};
const SMALL: PitonSpec = {
  cx: 3.5, cz: -1.0, levels: 4, segH: 0.4, baseW: 0.34, topW: 0.72,
