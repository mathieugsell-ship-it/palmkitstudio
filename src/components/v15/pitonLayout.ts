...
// ---- placement (tunable) — back-right, open water, clear of the island ------
const MAIN: PitonSpec = {
  cx: 2.5, cz: -1.2, levels: 7, segH: 0.42, baseW: 0.5, topW: 1.12,
  rootDepth: 0.32, driftX: -0.2, driftZ: 0.1, seed: 11,
};
const SMALL: PitonSpec = {
  cx: 3.35, cz: -0.45, levels: 4, segH: 0.4, baseW: 0.34, topW: 0.72,
