...
// ---- placement (tunable) — v41: the two karst stacks are GROUPED close on the
// left (small pulled in beside the big one, out of the palm zone) so they read as
// a pair, with the rising sun peeking in the gap between them (its right edge
// partially framed by the small stack). Bases on the back-left water (verified).
...
const SMALL: PitonSpec = {
  cx: -5.2, cz: -5.3, levels: 4, segH: 0.4, baseW: 0.34, topW: 0.72,
